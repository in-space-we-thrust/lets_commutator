...
class Device:
    def __init__(self, id, connection, name):
        self.id = id
...
class Sensor(Device):
    def __init__(self, id, connection, name, units, processing=None):
        super().__init__(id, connection, name)
        self.units = units
        self.value = None
...
class Valve(Device):
    def __init__(self, id, connection, name, pin, default_status=False):
        super().__init__(id, connection, name)
        self.pin = pin
